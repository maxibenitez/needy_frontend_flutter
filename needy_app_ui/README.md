## Needy App UI package

Needy App UI package containing a general design system.
...
│   │       ├── colors
│   │       ├── icons
│   │       │      ├── needy_app_icons_dark.dart
│   │       │      ├── needy_app_icons_light.dart
│   │       │      └── needy_app_icons.dart 
│   │       ├── spacing
│   │       ├── theme
│   │       ├── typography
│   │       └── widgets
│   │             ├── needy_app_app_bar.dart
│   │             ├── needy_app_outlined_button.dart
│   │             └── needy_app_text_field.dart 
│   ├── needy_app_ui.dart
│   ├── .gitignore
...
```
2) In `needy_app_icons_light.dart` add the icon with its color respectively of the theme. 
...
3) In `needy_app_icons_dark.dart` add the icon with its color respectively of the theme. 
